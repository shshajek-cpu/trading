...
**지표** — 거래량(급증 강조 옵션), 거래량 급증(σ 단계별 색 + 배경 강조), SMA/EMA/WMA/VWMA, 볼린저 밴드,
VWAP, 일목균형표, 파라볼릭 SAR, RSI, MACD, 스토캐스틱, 스토캐스틱 RSI, ATR, CCI, OBV, 윌리엄스 %R, MFI, ADX.
검색·즐겨찾기 가능한 지표 창, 지표 템플릿 저장/적용. 지표는 진행 중인 봉도 1초마다 다시 계산한다.
