...
**지표** — 거래량(급증 강조 옵션), 거래량 급증(직전 N봉 평균의 몇 배인지로 Lv1 메로나·Lv2 옐로우·Lv3 레드,
...
CCI, OBV, 윌리엄스 %R, MFI, ADX. 검색·즐겨찾기 가능한 지표 창(맨 위 "이평선 · 거래량 급증 · RSI 세트" 한 번에
넣기), 지표 템플릿 저장/적용. 지표는 진행 중인 봉도 1초마다 다시 계산한다.
